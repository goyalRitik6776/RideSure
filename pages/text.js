...
import pass from '../assets/greenTick.png'
import fail from '../assets/red-cross.png'
...
const thanks = () => {
  ...
  const [order,setOrder] = useState(
    {
      img:fail,
      heading:"OOPS!",
      details:"Looks like your payment has failed.Please try again!"
  ...
  //   img:pass,
  //   heading:"Thank you!",
  //   details:"Thanks for being awesome,we hope you enjoy your ride!"

  // }
  {orderStatus?(setOrder({
    img:pass,
    heading:"Thank you!",
    details:"Thanks for being awesome,we hope you enjoy your ride!"
  ...
  return (
    ...
    <div className={style.container}>
        ...
        <div className={style.upperHalf}>
            ...
            height={60}
            width={60}/> </div>
            <h1 className={style.heading}>{order.heading}</h1>
        </div>
        <div className={style.lowerHalf}>
            <div className={style.details}>{order.details}</div>
            <Link href="/Ride">
