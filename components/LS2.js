...
const style = {
  wrapper: `pt-2 `,
  searchHeader: `w-full font-bold text-left flex items-center text-3xl p-4 pl-5 overflow-hidden h-[13vh]`,
  ...
  invisible: `invisible`,
  suggestion: `rounded bg-gray-200 hover:bg-gray-400 py-1 px-4 block whitespace-no-wrap  border border-black`,
  ...
  suggestionD:`rounded bg-gray-200 hover:bg-gray-400 py-1 px-4 block whitespace-no-wrap border border-black`
};
